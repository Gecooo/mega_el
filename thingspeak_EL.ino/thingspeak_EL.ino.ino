...
#define INT1 9 // H-bridge leg 1 ->INT1
#define INT2 10 // H-bridge leg 2 ->INT2
...
void setup() {
  ...
  Serial.begin(9600); 
  Serial.println("");
  Serial.println("EL-Client starting! V3");
...
Serial.println("esp.GetWifiStatus()");
  ...
  Serial.println("EL-REST ready");
   myPID.SetOutputLimits(10000,65500);    //лимит PID  
   InitTimersSafe();
 ...
 // if we're connected make an REST request
  ...
  if (currentMillis - previousMillis >= 5000) {
    ...
    previousMillis = currentMillis;
      ...
      String HRadString = String(memoryFree());
